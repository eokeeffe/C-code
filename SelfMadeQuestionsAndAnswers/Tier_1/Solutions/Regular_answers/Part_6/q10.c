...
int main()
{
	char user_string_input[20] , user_letter_input , replacement_character ,capture_the_rogue_character;
	...
	printf("please enter the letter you want have replaced in the string\r\n");
	scanf("%c",&user_letter_input);
	capture_the_rogue_character = getchar();
	
	printf("please enter the replacement letter\r\n");
	...
	while(loop_counter<control_statement)
	{
		if(user_string_input[loop_counter]==user_letter_input)
		{
			...
			user_string_input[loop_counter]=replacement_character;
	...
	printf("The letter %c has been replaced in the places\r\n",user_letter_input);
